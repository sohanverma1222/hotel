      ...
      {viewMode === 'calendar' && (
        <BookingCalendar
          reservations={reservations.map(r => ({
            id: r._id?.toString() || '',
            guestName: 'Guest', // You'd need to populate this with actual guest data
            roomNumber: r.roomId?.toString() || 'Unknown',
            checkIn: new Date(r.checkIn),
            checkOut: new Date(r.checkOut),
            status: r.status as 'confirmed' | 'checked_in' | 'checked_out' | 'cancelled',
          ...
          onReservationClick={(reservation) => {
            ...
            // Handle reservation click for editing
          }}
        />
      )}
